  ...
  return (
    <>
      <MotionGrid
        ...
        h="100%"
        w="100%"
        templateColumns={["1fr", "1fr", "1fr", "1fr", "1fr", "repeat(2, 1fr)"]}
      ...
      >
        {isLoading ? (
          <Flex alignItems="center" h="300px" w="100vw" justifyContent="center">
      ...
      <Flex
        ...
        mt={isToChangeUiLayout ? "6" : ""}
        position={!isToChangeUiLayout ? "fixed" : "initial"}
        bottom={!isToChangeUiLayout ? "20px" : ""}
      >
        <Pagination
